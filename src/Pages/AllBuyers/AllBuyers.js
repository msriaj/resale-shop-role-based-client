...
const AllBuyers = () => {
  const { data, isLoading, refetch } = useQuery(["allBuyers"], () =>
    Axios.get("/api/all-buyer").then((result) => result.data)
  );
