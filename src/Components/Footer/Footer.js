  ...
  return (
    <div>
      <footer class="text-gray-600 body-font">
        <div class=" px-5 py-24 bg-[#DDDDDD]">
          <div class=" w-10/12 mx-auto flex flex-wrap md:text-left text-center order-first">
            ...
            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <p class=" text-sm mt-2 md:text-left text-center">
        ...
        <div class="bg-[#444444] text-white">
          <div class="w-10/12 mx-auto px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
